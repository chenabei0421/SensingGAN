...
class DenoisingDataset(Dataset):
    ...
    def __getitem__(self, index):
        ## read an image
        raindrop_img_rainy, raindrop_img_gt = self.imglist[index][0], self.imglist[index][1]
        img_rainy = cv2.imread(raindrop_img_rainy)
        img_gt = cv2.imread(raindrop_img_gt)
...
class DenoisingValDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return img_rainy, img_gt, height_origin, width_origin, os.path.basename(self.imglist[index][0])
