...
class Generator (nn.Module):
    ...
    def forward(self, Rainy_image_x, Rainy_image):
        ...
        #Rain De-raining Module: SA-SkipNet
...
class Discriminator(nn.Module):
    def __init__(self, batch_size=8, conv_dim=64):
        ...
        layer1.append(SpectralNorm(nn.Conv2d(3, conv_dim, 4, 2, 1)))  #256=>128, C64
        layer1.append(nn.LeakyReLU(0.1))
        curr_dim = conv_dim

        layer2.append(SpectralNorm(nn.Conv2d(curr_dim, curr_dim*2, 4, 2, 1)))  #128=>64, C128
        layer2.append(nn.LeakyReLU(0.1))
        curr_dim = curr_dim * 2

        layer3.append(SpectralNorm(nn.Conv2d(curr_dim, curr_dim*2, 4, 2, 1)))  #64=>32, C256
        layer3.append(nn.LeakyReLU(0.1))
        curr_dim = curr_dim * 2

        layer4.append(SpectralNorm(nn.Conv2d(curr_dim, curr_dim*2, 4, 2, 1)))  #32=>16, C512
        layer4.append(nn.LeakyReLU(0.1))
        curr_dim = curr_dim * 2
        
        layer5.append(SpectralNorm(nn.Conv2d(curr_dim, 32, 3, 1, 1)))  #16*16*32
