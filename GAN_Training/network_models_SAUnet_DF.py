...
class Generator (nn.Module):
    ...
    def forward(self, Rainy_image_x, Rainy_image):
        ...
        pred1 = self.kernel_pred(Rainy_image, core, white_level=1.0, rate=1)
        pred2 = self.kernel_pred(Rainy_image, core, white_level=1.0, rate=2)
        pred3 = self.kernel_pred(Rainy_image, core, white_level=1.0, rate=3)
        pred4 = self.kernel_pred(Rainy_image, core, white_level=1.0, rate=4)
